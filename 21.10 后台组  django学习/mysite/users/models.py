...
class UserProfile(models.Model):
    ...
    gexing = models.CharField('个性签名',max_length=50,blank=True,default='')
    ...
    image = models.ImageField(upload_to='images/%Y/%m',default='images/default.jpg',max_length=50,verbose_name= '用户头像')
#用的一对一数据库关联方法

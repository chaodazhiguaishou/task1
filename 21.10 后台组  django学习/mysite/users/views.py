...
from .forms import LoginForm,ForgetPwdForm,ModifyPwdForm,RegisterForm,UserForm,UserProfileForm
...
def login_view(request):#注意 要必须此处定义与上方引入的重复
    ...
    if request.method == 'GET':
        ...
        if form.is_valid():
            ...
            if exists:
                ...
                return HttpResponse('邮件邮件发送请查收')
            else:
                return HttpResponse('邮件还未注册，请前往注册')
